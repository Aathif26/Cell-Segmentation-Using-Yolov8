...
from cellSegmentation.entity.artifacts_entity import (DataIngestionArtificat, DataValidationArtifact)
...
class DataValidation:
    def __init__(
            self, 
            data_ingestion_artifact: DataIngestionArtificat,
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        logging.info("Entered initiate_data_validation method for DataValidation class")
        try:
